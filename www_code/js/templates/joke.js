...
<ion-tabs class="tabs-icon-top tabs-color-{{$root.skin}}">\
	<ion-tab badge="$root.newJokes" badge-style="badge-assertive" title="笑话" icon-on="ion-happy" icon-off="ion-happy" ng-click="go(\'/tabs/joke\')"><ion-nav-view name="joke"></ion-nav-view></ion-tab>\
